...
test("fails closed without rendering protected portal content", async ({ page }) => {
  ...
  await expect(page.getByRole("link", { name: "Volver al estado del plano de control" })).toHaveAttribute(
    "href",
    "/",
  );
