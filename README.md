...
- Local demonstration profile: Windows 11 VM, public/synthetic data,
  ...
  history and a 120-second client timeout. This profile is not a corporate
  pilot.
- Data policy: synthetic data, deterministic fakes, and `lab-real-sanitized`
  data generated by controlled local laboratory components only.
...
[`docs/modules/local-mvp-lab.md`](docs/modules/local-mvp-lab.md), and the
five-unit lab-real data route is defined in
